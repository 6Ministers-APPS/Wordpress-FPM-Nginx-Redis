...
# ==============================================================================
# ГЕНЕРАЦИЯ КЛЮЧЕЙ БЕЗОПАСНОСТИ (SALTS)
# ==============================================================================
echo "🔑 Генерирую уникальные ключи безопасности..."

# Эта команда скачивает новые ключи и заменяет ими старые в wp-config.php
wp config shuffle-salts --allow-root --path=/var/www/html

# Сбрасываем кэш, чтобы изменения вступили в силу (на всякий случай)
